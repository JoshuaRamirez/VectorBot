...
class TestMain:
    ...
    def test_Main_WithConfigInfoFlag_ReturnsZero(self, mock_console: Any) -> None:
    ...
    def test_Main_WithEnvFlag_PassesToAllCommands(self, mock_console: Any) -> None:
    ...
    def test_Main_WithConfigInfoAndEnv_ShowsEnvironmentSpecificConfig(self, mock_console: Any) -> None:
    ...
    def test_Main_WithConfigInfo_ShowsConfigurationDetails(self, mock_console: Any) -> None:
...
class TestSpecialCases:
    ...
    def test_Main_WithBothConfigInfoAndCommand_ConfigInfoTakesPrecedence(self, mock_console: Any) -> None:
